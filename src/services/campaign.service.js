...
async function getCampaignById(id) {
  const campaign = await CampaignMaster.findByPk(id, {
    include: [
      ...
      { association: "media", required: false },
      { association: "banners", required: false },
      { association: "amenities", required: false },
      { association: "projectImages", required: false },
      { association: "highlights", required: false },
